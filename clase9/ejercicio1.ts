...
Cada mueble tiene un nombre, un precio y un identificador único. Implementa las siguientes funciones:
•
...
//Tupla para el mueble. Cada mueble tiene un nombre, un precio y un identificador único
...
//Actualizar el precio de un mueble
